...
const navigate=useNavigate();
  ...
  useEffect(() => {
    const fetch = async () => {
      const response = await axios.get(
        `https://bookstore-3-8nm0.onrender.com/api/v1/get-book-by-id${id}`
      );
  ...
  const handleFavourite=async ()=>{
    ...
    try {
      ...
      const response= await axios.put("https://bookstore-3-8nm0.onrender.com/api/v1/add-book-in-favi",{},{headers});
   ...
   const addToCart=async ()=>{
    ...
    try {
      ...
      const response= await axios.put("https://bookstore-3-8nm0.onrender.com/api/v1/add-to-cart",{},{headers});
   ...
   const deletebook=async ()=>{
    const response= await axios.delete("https://bookstore-3-8nm0.onrender.com/api/v1/delete-book",{headers});
